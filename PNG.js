...
import { crc32 } from "https://taisukef.github.io/zlib.js/es/crc32.js";
 ...
 * @param {!Object=} opt_param かならず width と height が必要となる.
 * @constructor
 */
CanvasTool.PngEncoder = function(data, width, height, opt_param) {
  /**
...
CanvasTool.PngEncoder.prototype.makeiCCP_ = function(iccp) {
  ...
  switch (iccp.compressionMethod) {
    case CanvasTool.PngEncoder.CompressionMethod.DEFLATE:
      push_(data, deflate(iccp.profile, this.deflateOption));
      break;
    default:
...
CanvasTool.PngEncoder.prototype.makeChunk_ = function(type, data) {
  ...
  push_(chunk, this.networkByteOrder_(crc32(crcTarget), 4));
...
const encode = (imgd, width, height) => {
  const opt_params = {};
